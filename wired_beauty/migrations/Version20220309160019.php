 ...
 */
<<<<<<< HEAD:wired_beauty/migrations/Version20220309150240.php
final class Version20220309150240 extends AbstractMigration
=======
final class Version20220309160019 extends AbstractMigration
>>>>>>> ab6ea684b0e171752f93a25ead71c804b235a1c0:wired_beauty/migrations/Version20220309160019.php
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE campain (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, company_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, qcm_file LONGTEXT DEFAULT NULL, INDEX IDX_B9277B3F4584665A (product_id), INDEX IDX_B9277B3F979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE campain_registration (id INT AUTO_INCREMENT NOT NULL, tester_id INT NOT NULL, campain_id INT NOT NULL, status LONGTEXT NOT NULL, INDEX IDX_9066E249979A21C1 (tester_id), INDEX IDX_9066E24920B77272 (campain_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, company_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, uv_protection INT DEFAULT NULL, INDEX IDX_D34A04AD979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE qcm (id INT AUTO_INCREMENT NOT NULL, campain_id INT NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_D7A1FEF420B77272 (campain_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, age INT NOT NULL, height INT NOT NULL, weight INT NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_qcm_response (id INT AUTO_INCREMENT NOT NULL, campain_registration_id INT NOT NULL, content LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', UNIQUE INDEX UNIQ_5F6B523AD19326EC (campain_registration_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE campain ADD CONSTRAINT FK_B9277B3F979B1AD6 FOREIGN KEY (company_id) REFERENCES company (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE campain DROP FOREIGN KEY FK_B9277B3F979B1AD6');
