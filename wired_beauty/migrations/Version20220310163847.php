 ...
 */
final class Version20220310163847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE campain_registration (id INT AUTO_INCREMENT NOT NULL, tester_id INT NOT NULL, campain_id INT NOT NULL, status INT DEFAULT 0 NOT NULL, INDEX IDX_9066E249979A21C1 (tester_id), INDEX IDX_9066E24920B77272 (campain_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
